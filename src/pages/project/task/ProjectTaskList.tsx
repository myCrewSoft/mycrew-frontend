  ...
  return (
    <div className="overflow-x-auto rounded-lg border border-slate-200 bg-white">
      <div className="min-w-[980px]">
        <div className="grid grid-cols-[1.35fr_0.55fr_0.5fr_0.55fr_0.65fr_0.85fr_0.55fr_0.55fr_40px] items-center bg-slate-50 px-5 py-3 text-xs font-bold text-slate-500">
          <span>업무명</span>
          <span>업무 타입</span>
          <span>구분</span>
          <span>상태</span>
        ...
        <div className="divide-y divide-slate-100">
          {tasks.map((task) => (
            <div
              key={task.taskId}
              className="grid grid-cols-[1.35fr_0.55fr_0.5fr_0.55fr_0.65fr_0.85fr_0.55fr_0.55fr_40px] items-center px-5 py-3 text-sm transition-colors hover:bg-slate-50"
            >
              <button
                type="button"
